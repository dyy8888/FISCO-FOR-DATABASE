...
#define KingBaseStorage_LOG(LEVEL) LOG(LEVEL) << "[KingBaseStorage] " 

namespace dev
{
namespace storage
{
class KingBaseStorage : public Storage
{
public:
    typedef std::shared_ptr<KingBaseStorage> Ptr;   

    KingBaseStorage();
    virtual ~KingBaseStorage(){};
