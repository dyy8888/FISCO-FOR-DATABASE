...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/evmone-stamp/evmone-install-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/evmone-stamp/evmone-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/evmone-stamp/evmone-install-*.log")
  endif()
  ...
  set(msg "evmone install command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/evmone-stamp/evmone-install-*.log")
  message(STATUS "${msg}")
endif()
