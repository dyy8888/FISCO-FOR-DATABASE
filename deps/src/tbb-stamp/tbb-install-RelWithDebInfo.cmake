...
set(command "bash;-c;/bin/cp -f */libtbb.a* /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/lib/")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-install-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-install-*.log")
  endif()
  ...
  set(msg "tbb install command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-install-*.log")
  message(STATUS "${msg}")
endif()
