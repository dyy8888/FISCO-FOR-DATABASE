...
set(command "make;extra_inc=big_iron.inc")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-build-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-build-*.log")
  endif()
  ...
  set(msg "tbb build command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/tbb-stamp/tbb-build-*.log")
  message(STATUS "${msg}")
endif()
