...
set(command "./b2;stage;cxxflags=-march=x86-64 -mtune=generic -fvisibility=hidden -fvisibility-inlines-hidden;threading=multi;link=static;variant=release;address-model=64;--with-chrono;--with-date_time;--with-filesystem;--with-system;--with-random;--with-regex;--with-test;--with-thread;--with-serialization;--with-program_options;--with-log;--with-iostreams;-s;NO_BZIP2=1;-s;NO_LZMA=1;-s;NO_ZSTD=1;-j2")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/boost-stamp/boost-build-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/boost-stamp/boost-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/boost-stamp/boost-build-*.log")
  endif()
  ...
  set(msg "boost build command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/boost-stamp/boost-build-*.log")
  message(STATUS "${msg}")
endif()
