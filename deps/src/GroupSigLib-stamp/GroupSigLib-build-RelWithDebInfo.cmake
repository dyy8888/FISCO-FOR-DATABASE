...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/GroupSigLib-stamp/GroupSigLib-build-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/GroupSigLib-stamp/GroupSigLib-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/GroupSigLib-stamp/GroupSigLib-build-*.log")
  endif()
  ...
  set(msg "GroupSigLib build command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/GroupSigLib-stamp/GroupSigLib-build-*.log")
  message(STATUS "${msg}")
endif()
