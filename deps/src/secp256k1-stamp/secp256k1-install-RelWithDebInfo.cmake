...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-install-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-install-*.log")
  endif()
  ...
  set(msg "secp256k1 install command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-install-*.log")
  message(STATUS "${msg}")
endif()
