...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-build-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-build-*.log")
  endif()
  ...
  set(msg "secp256k1 build command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/secp256k1-stamp/secp256k1-build-*.log")
  message(STATUS "${msg}")
endif()
