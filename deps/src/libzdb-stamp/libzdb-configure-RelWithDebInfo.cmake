...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/libzdb-stamp/libzdb-configure-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/libzdb-stamp/libzdb-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/libzdb-stamp/libzdb-configure-*.log")
  endif()
  ...
  set(msg "libzdb configure command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/libzdb-stamp/libzdb-configure-*.log")
  message(STATUS "${msg}")
endif()
