...
set(stdout_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/rocksdb-stamp/rocksdb-build-out.log")
set(stderr_log "/home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/rocksdb-stamp/rocksdb-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/rocksdb-stamp/rocksdb-build-*.log")
  endif()
  ...
  set(msg "rocksdb build command succeeded.  See also /home/dyy/FISCO-TIDY/FISCO-BCOS-2.9.1/deps/src/rocksdb-stamp/rocksdb-build-*.log")
  message(STATUS "${msg}")
endif()
